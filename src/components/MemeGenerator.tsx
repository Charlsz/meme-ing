...
export default function MemeGenerator() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-center mb-8">Meme-ing</h1>
      ...
      <div className="text-center mt-6 text-sm text-gray-600">
        Made by <a href="https://charlsz.netlify.app/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">Charlie</a>
        {' • '}
        <a href="https://github.com/Charlsz" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">GitHub</a>
      </div>
    </div>
  );
}